...
plt.plot(x, y, 'm')
plt.title("Sygnał zdomulowany ASK")
plt.xlabel("czas[s]")
...
x = skala(fs, N)
plt.plot(x, y, 'm')
plt.title("Widnmo modulacji ASK")
...
plt.plot(x1, y1)
plt.title("Sygnał zdomulowany PSK")
plt.xlabel("czas[s]")
plt.ylabel("amplituda")
plt.show()
# plt.savefig('zp.png')
...
x1 = skala(fs, N)
plt.plot(x1, y1)
plt.title("Widnmo modulacji PSK")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Wielkość")
...
plt.plot(x2, y2, 'g')
plt.title("Sygnał zdomulowany FSK")
plt.xlabel("czas[s]")
plt.ylabel("amplituda")
plt.show()
# plt.savefig('zf.png')
...
x2 = skala(fs, N)
plt.plot(x2, y2, 'g')
plt.title("Widnmo modulacji FSK")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Wielkość")
