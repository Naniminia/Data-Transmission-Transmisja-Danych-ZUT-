...
x1 = skala(fs, N)
plt.plot(x1, y1)
plt.title("Widmo dla za_a")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('za_a_widmo.png')

xb, yb = wywolanie(Tc, fs, N, partial(za, ka=6))
M(yb, N)
y2 = Mprim(yb, N)
x2 = skala(fs, N)
plt.plot(x2, y2)
plt.title("Widmo dla za_b")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('za_b_widmo.png')

xc, yc = wywolanie(Tc, fs, N, partial(za, ka=26))
M(yc, N)
y3 = Mprim(yc, N)
x3 = skala(fs, N)
plt.plot(x3, y3)
plt.title("Widmo dla za_c")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('za_c_widmo.png')

xpa, ypa = wywolanie(Tc, fs, N, partial(zp, kp=0.5))
M(ypa, N)
y4 = Mprim(ypa, N)
x4 = skala(fs, N)
plt.plot(x4, y4, 'm')
plt.title("Widmo dla zp_a")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('zp_a_widmo.png')

xpb, ypb = wywolanie(Tc, fs, N, partial(zp, kp=math.pi/2))
M(ypb, N)
y5 = Mprim(ypb, N)
x5 = skala(fs, N)
plt.plot(x5, y5, 'm')
plt.title("Widmo dla zp_b")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('zp_b_widmo.png')

xpc, ypc = wywolanie(Tc, fs, N, partial(zp, kp=4*math.pi))
M(ypc, N)
y6 = Mprim(ypc, N)
x6 = skala(fs, N)
plt.plot(x6, y6, 'm')
plt.title("Widmo dla zp_c")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('zp_c_widmo.png')

xfa, yfa = wywolanie(Tc, fs, N, partial(zf, kf=0.12))
M(yfa, N)
y7 = Mprim(yfa, N)
x7 = skala(fs, N)
plt.plot(x7, y7, 'g')
plt.title("Widmo dla zf_a")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('zf_a_widmo.png')

xfb, yfb = wywolanie(Tc, fs, N, partial(zf, kf=math.pi/3))
M(yfb, N)
y8 = Mprim(yfb, N)
x8 = skala(fs, N)
plt.plot(x8, y8, 'g')
plt.title("Widmo dla zf_b")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
# plt.savefig('zf_b_widmo.png')

xfc, yfc = wywolanie(Tc, fs, N, partial(zf, kf=5*math.pi))
M(yfc, N)
y9 = Mprim(yfc, N)
x9 = skala(fs, N)
plt.plot(x9, y9, 'g')
plt.title("Widmo dla zff_c")
plt.xlabel("CZęstotliwość[Hz]")
plt.ylabel("Amplituda[Db]")
plt.show()
